...
# #—Chicago, New York City, and Washington. You will write code to import the data and answer interesting questions about it
...
#Given: Creating a dictionary containing the data sources for the three cities
...
# a comment to show a new change
...
def get_filters():
    ...
    while month not in MONTH_DATA.keys():
        print("\nPlease enter the month, between January to June or all:")
        month = input().lower()
    ...
    while day not in DAY_LIST:
        print("\nPlease enter a specific day in the week:")
        day = input().lower()

        if day not in DAY_LIST:
            print("\nInvalid input. Please try again.")
# showing the user the day he/she entered
...
#here I needed help so I looked the imput for time code
def time_stats(df):
